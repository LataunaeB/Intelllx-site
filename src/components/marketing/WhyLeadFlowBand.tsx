            ...
            >
              {STEPS.map(({ num, title, body, Icon }) => (
                <motion.div key={num} variants={item}>
                  <article className="relative z-30 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 hover:bg-white/10 transition-all duration-200 hover:shadow-lg">
