...
export default function LeadFlowChatbot() {
  ...
  const faqResponses: { [key: string]: string } = {
    ...
    'price': `LeadFlow Chatbot is ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}. Setup includes custom conversation design, knowledge training, branding, and CRM integration. Monthly covers optimization, reports, and 7 hours support. Most clients see ROI within 30 days!`,
    'cost': `Our pricing is ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}. The setup covers everything needed to get started, and monthly includes ongoing optimization and support. Most businesses see 3-5x more qualified leads, so the ${pricing.products.chatbot.pro.monthlyService.priceDisplay} pays for itself with just 1-2 additional customers.`,
    'pricing': `LeadFlow Chatbot costs ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}. Setup includes custom design, knowledge training, branding, and integrations. Monthly covers optimization, reporting, and support. Most clients see ROI within 30 days.`,
    'expensive': `I understand cost concerns! Our ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay} typically pays for itself within 30 days. Most clients see 3-5x more qualified leads, so just 1-2 additional customers per month covers the cost. It's like having a sales team member for a fraction of the cost.`,
    'cheap': `You're right - it's very affordable! For ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}, you get a complete 24/7 lead generation system. Compare that to hiring a salesperson ($3,000-5,000/month) or missing leads. Most clients see ROI within 30 days.`,
    'budget': `Our ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay} is a fraction of what most businesses spend on lead generation. Most clients see 3-5x more qualified leads, so the ${pricing.products.chatbot.pro.monthlyService.priceDisplay} pays for itself with just 1-2 additional customers.`,
    
    // Website Development Pricing
    'website price': `Website development starts at ${pricing.products.website.launch.priceDisplay} for a Launch package (1-3 pages, responsive design, SEO). Professional websites are ${pricing.products.website.professional.priceDisplay} (4-6 pages, advanced features). Advanced websites start at ${pricing.products.website.advanced.priceDisplay} (7-12 pages, custom functionality). All include modern design, mobile optimization, and fast loading.`,
    'website cost': `Website development pricing: Launch ${pricing.products.website.launch.priceDisplay} (1-3 pages), Professional ${pricing.products.website.professional.priceDisplay} (4-6 pages), Advanced ${pricing.products.website.advanced.priceDisplay} (7-12 pages). All include responsive design, SEO optimization, fast loading, and mobile-first approach.`,
    'website pricing': `We offer 3 website packages: Launch (${pricing.products.website.launch.priceDisplay}) - 1-3 pages, Professional (${pricing.products.website.professional.priceDisplay}) - 4-6 pages, Advanced (${pricing.products.website.advanced.priceDisplay}) - 7-12 pages. All include responsive design, SEO, fast loading, and modern technologies.`,
    'website budget': `Website development starts at ${pricing.products.website.launch.priceDisplay} for a complete Launch website. Professional websites are ${pricing.products.website.professional.priceDisplay} with advanced features. Advanced websites start at ${pricing.products.website.advanced.priceDisplay} for complex needs. All include responsive design, SEO, and fast loading.`,
    'website expensive': `Our website pricing is very competitive! Launch websites start at ${pricing.products.website.launch.priceDisplay} (complete with 1-3 pages, responsive design, SEO). Compare to agencies charging $5,000-15,000+ for similar work. We deliver professional results at a fraction of the cost.`,
    'website cheap': `You're right - our website pricing is very affordable! Launch websites start at ${pricing.products.website.launch.priceDisplay} with everything included. Professional websites are ${pricing.products.website.professional.priceDisplay} with advanced features. We use modern technologies and deliver professional results at competitive prices.`,
    ...
    'website': `We build custom websites using modern technologies like Next.js, React, and Tailwind CSS. Our websites are fast, mobile-responsive, SEO-optimized, and designed to convert visitors into customers. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'website development': `We build custom websites using modern technologies like Next.js, React, and Tailwind CSS. Our websites are fast, mobile-responsive, SEO-optimized, and designed to convert visitors into customers. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'web development': `We build custom websites using modern technologies like Next.js, React, and Tailwind CSS. Our websites are fast, mobile-responsive, SEO-optimized, and designed to convert visitors into customers. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'website design': `We create beautiful, modern website designs that are mobile-responsive and optimized for conversions. Our designs are custom-built for your brand and business goals. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'custom website': `We build custom websites tailored to your business needs. Our websites are fast, mobile-responsive, SEO-optimized, and designed to convert visitors into customers. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'new website': `We can build you a brand new website from scratch! Our websites are modern, fast, mobile-responsive, and SEO-optimized. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    'website redesign': `We can redesign your existing website to make it modern, fast, and mobile-responsive. Our redesigns improve user experience, SEO, and conversions. We offer 3 packages: Launch (${pricing.products.website.launch.priceDisplay}), Professional (${pricing.products.website.professional.priceDisplay}), and Advanced (${pricing.products.website.advanced.priceDisplay}).`,
    ...
    'saas': 'SaaS companies can use LeadFlow to: Qualify prospects, answer technical questions, book consultations, capture enterprise leads, and guide onboarding. The chatbot is designed to help improve lead-to-customer conversions.',
    ...
    'roi': `Our goal is to help you see ROI within 30 days. Typical expected results: 3-5x more qualified leads, 25-40% increase in conversions, 40-60% reduction in missed opportunities, 2-3x more appointments booked. The ${pricing.products.chatbot.pro.monthlyService.priceDisplay} is designed to pay for itself with just 1-2 additional customers.`,
    ...
    'scam': `I understand your concern! LeadFlow is a legitimate, proven service. We're transparent about pricing (${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}), provide detailed contracts, and have real clients who can vouch for our results. We deliver what we promise - a working chatbot that generates leads.`,
    'trust': `I understand your concern! LeadFlow is a legitimate, proven service. We're transparent about pricing (${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}), provide detailed contracts, and have real clients who can vouch for our results. We deliver what we promise - a working chatbot that generates leads.`,
    'legitimate': `I understand your concern! LeadFlow is a legitimate, proven service. We're transparent about pricing (${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}), provide detailed contracts, and have real clients who can vouch for our results. We deliver what we promise - a working chatbot that generates leads.`,
    ...
    'website options': `We offer 3 website options: Launch (${pricing.products.website.launch.priceDisplay}) - perfect for small businesses, Professional (${pricing.products.website.professional.priceDisplay}) - ideal for growing businesses, Advanced (${pricing.products.website.advanced.priceDisplay}) - for large businesses with complex needs. All include responsive design and SEO.`,
    'website starter': `Launch website (${pricing.products.website.launch.priceDisplay}): 1-3 pages, responsive design, SEO optimization, fast loading, contact forms, analytics setup, and 2 weeks delivery. Perfect for small businesses and startups.`,
    'website professional': `Professional website (${pricing.products.website.professional.priceDisplay}): 4-6 pages, advanced features, custom integrations, advanced SEO, content management, and 3-4 weeks delivery. Ideal for growing businesses.`,
    'website enterprise': `Advanced website (${pricing.products.website.advanced.priceDisplay}): 7-12 pages, custom functionality, e-commerce integration, advanced features, and 6-8 weeks delivery. For large businesses with complex needs.`,
    ...
    'website info': `Our website intelllx.com has everything you need: Homepage with service overview, Services page with detailed LeadFlow information, Pricing page with ${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay} pricing, About page with company information, Contact page to reach us directly, and this chatbot for instant answers. What would you like to know more about?`
  };
  ...
  const getBotResponse = (input: string): string => {
    ...
    const defaultResponses = [
      `That's a great question! I'm here to help you learn about LeadFlow. You can ask me about pricing (${pricing.products.chatbot.pro.priceDisplay} setup + ${pricing.products.chatbot.pro.monthlyService.priceDisplay}), how it works, lead conversion, ROI, features, or book a discovery call. What interests you most?`,
