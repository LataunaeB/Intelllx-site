...
export default function LeadFlowChatbot() {
  ...
  const faqResponses: { [key: string]: string } = {
    ...
    'website budget': `Website development: Launch ${pricing.products.website.launch.priceDisplay} (complete website). Professional websites are ${pricing.products.website.professional.priceDisplay} with advanced features. Advanced websites are ${pricing.products.website.advanced.priceDisplay} for complex needs. All include responsive design, SEO, and fast loading.`,
    'website expensive': `Our website pricing is very competitive! Launch websites are ${pricing.products.website.launch.priceDisplay} (complete with 1-3 pages, responsive design, SEO). Compare to agencies charging $5,000-15,000+ for similar work. We deliver professional results at a fraction of the cost.`,
    'website cheap': `You're right - our website pricing is very affordable! Launch websites are ${pricing.products.website.launch.priceDisplay} with everything included. Professional websites are ${pricing.products.website.professional.priceDisplay} with advanced features. We use modern technologies and deliver professional results at competitive prices.`,
