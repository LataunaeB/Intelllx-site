          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 xl:gap-24 items-center">
            ...
            <div className="space-y-6 lg:space-y-10 relative">
              ...
              <div className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
                ...
                <div className="mt-6 space-y-2 text-left">
                  ...
                  <p className="text-sm md:text-base text-gray-300 font-light">First 10 stylists get personal customization</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:pl-8">
              <div className="relative animate-fade-in" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="mt-6 lg:mt-0 lg:absolute lg:-right-6 xl:-right-12 lg:top-1/2 lg:-translate-y-1/2 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-10 xl:gap-12 max-w-5xl lg:max-w-6xl mx-auto">
            <div className="group relative rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10 backdrop-blur-xl hover:border-[#06B6D4]/30 hover:bg-white/8 transition-all duration-700 hover:-translate-y-2">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-semibold text-white mb-4">Your Brand Instantly Feels High-End</h3>
                ...
                <ul className="mt-4 space-y-3 text-base md:text-lg text-gray-200">
            ...
            <div className="group relative rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10 backdrop-blur-xl hover:border-[#06B6D4]/30 hover:bg-white/8 transition-all duration-700 hover:-translate-y-2">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-semibold text-white mb-4">No More Chasing Clients</h3>
                <p className="text-lg md:text-xl text-gray-200 leading-relaxed font-light">
