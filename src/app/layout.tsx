...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon-32x32.png?v=4&t=' + Date.now(), sizes: '32x32', type: 'image/png' },
      { url: '/favicon-16x16.png?v=4&t=' + Date.now(), sizes: '16x16', type: 'image/png' },
    ],
    shortcut: '/favicon-32x32.png?v=4&t=' + Date.now(),
    apple: [
      { url: '/apple-touch-icon.png?v=4&t=' + Date.now(), sizes: '180x180', type: 'image/png' },
    ],
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${script.variable}`}>
      <head>
        <link rel="icon" type="image/png" sizes="32x32" href={`/favicon-32x32.png?v=4&t=${Date.now()}`} />
...
// Force rebuild Wed Oct 22 08:14:23 PM PDT 2025
