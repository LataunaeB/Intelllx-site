      ...
      <body className="min-h-screen flex flex-col">
        <header className="sticky top-0 z-50 transition-all duration-300">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-4 flex items-center justify-between min-h-[80px]">
            ...
            <nav className="flex items-center gap-8 text-sm relative z-20">
              {site.nav.map((item) => (
                <Link 
                  key={item.href} 
                  href={item.href} 
                  className="relative font-bold text-base transition-all duration-300 hover:scale-105 transform group px-3 py-2 bg-white rounded-lg border border-gray-300"
                  style={{ color: '#000000' }}
                >
                  {item.label}
            ...
            <button className="md:hidden p-3 rounded-xl bg-gradient-to-r from-purple-100 to-pink-100 backdrop-blur-sm border border-purple-200 hover:from-purple-200 hover:to-pink-200 transition-all duration-300 hover:scale-105 transform">
